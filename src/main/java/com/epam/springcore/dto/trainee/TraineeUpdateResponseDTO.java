...
public class TraineeUpdateResponseDTO {
    ...
    public TraineeUpdateResponseDTO(String username, String firstName, String lastName, LocalDate dateOfBirth, String address, boolean isActive, List<TraineesTrainerResponseDTO> trainers) {
